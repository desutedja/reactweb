...
const columns = [
    ...
    { Header: 'Admin Fee', accessor: 'admin_fee' },
    { Header: 'Discount Fee', accessor: 'discount_fee' },
    { Header: 'PG Fee', accessor: 'pg_fee' },
...
function Component() {
    ...
    const { loading, items, total_pages, refreshToggle, alert } = useSelector(state => state.product);
