...
export const getAdmin = (pageIndex, pageSize, search = "") => (dispatch) => {
  dispatch(startAsync());
...
export const getAdminVasSales = (pageIndex, pageSize, search = "") => (
  dispatch
) => {
  dispatch(startAsync());
  ...
  dispatch(
    get(
      adminEndpoint +
        ...
        "&limit=" +
        pageSize +
        "&group=vas_sales,vas_advertiser" +
        "&sort_field=created_on&sort_type=DESC" +
        "&search=" +
        search,
