...
import RadioInputVoucher from "./RadioVoucher";
import RadioInputDiscType from "./RadioDiscType";
import MultiSelectInputBuilding from "./MultiSelectBuilding";
import MultiSelectInputMerchant from "./MultiSelectMerchant";
...
function Input({ optional = false, ...props }) {
  ...
  const renderInput = (type) => {
    switch (type) {
      ...
      case "multiselectbuilding":
        return <MultiSelectInputBuilding name={fixedName} {...inputProps} />;
      case "multiselectmerchant":
        return <MultiSelectInputMerchant name={fixedName} {...inputProps} />;
      ...
      case "radioVoucher":
        return <RadioInputVoucher name={fixedName} {...inputProps} />;
      case "radioDiscType":
        return <RadioInputDiscType name={fixedName} {...inputProps} />;
      case "file":
    ...
    >
      {!compact && (
        <>
          ...
          {hint && <div style={{ marginBottom: "8px" }}>*{hint}</div>}
        </>
      )}
      {renderInput(type)}
      {limit && (
