...
const types = [
    { label: "Single Building", value: "singlebuilding"},
    { label: "Multiple Building", value: "multibuilding"}
]
    ...
    return (
        <Template>
            ...
            <Form
                ...
                loading={loading}
            >
                <Input label="Title" type="text" placeholder="Input Announcement Title" inputValue={selected.title} />
