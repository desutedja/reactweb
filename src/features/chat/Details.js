...
function Component() {
    ...
    const { qiscusUser, qiscus, messages, joinedRooms } = useSelector(state => state.chat);
    ...
    useEffect(() => {
        ...
        //if (joinedRooms.includes(roomID)) {
            ...
            qiscus.addParticipantsToGroup && 
               qiscus.addParticipantsToGroup(roomID, [qiscusUser])
                .then(function(users) {
                    console.log(users);
                }).catch(function(error) {
                    alert("add participants failed");
                }) 
        }
        */
    ...
    useEffect(() => {
        ...
        qiscus.getParticipants && 
            qiscus.getParticipants("1641e1a7-6ec4-487b-be44-3e5ad584b54c")
