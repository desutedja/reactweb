...
function Component() {
  ...
  const handleReport = (data, withTimeline = true) => {
    setSummary([
      {
        label: "Impression",
        icon: "https://www.seekpng.com/png/small/204-2045343_png-file-data-management-icon-png.png",
        data: data.summary.total_repeated_impression,
      },
      {
        label: "Views",
        icon: "https://cdn.pixabay.com/photo/2016/12/18/11/04/eye-1915455_960_720.png",
        data: data.summary.total_repeated_view,
      },
      {
        label: "Click",
        icon: "https://www.clipartmax.com/png/full/350-3509969_fingerprint-icon-and-vector-click-icon-png-white.png",
