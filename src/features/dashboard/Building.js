...
function Component() {
  ...
  useEffect(() => {
    dispatch(
      get(endpointAdmin + "/building/unit/data?building_id=" + buildingName + "&building_section="  + tower +  
      "&date=" + periodeTime +
  ...
  useEffect(() => {
    dispatch(
      get(endpointManagement + "/admin/staff/data?building_id=" + buildingName + "&building_section="  + tower + 
      "&date=" + periodeTime +
      // ( periode === "year" ? periodeByYear 
      //   :
      //   periode === "month" ? periodeByMonth
                              ...
                              >
                                ...
                                <div className="row no-gutters align-items-center mt-2">
                                  <div className="col-auto">
                                    ...
                                    <AnimatedNumber
                                      className="font-weight-bold black ml-2"
                                      value={unitStatistic.registered_unit_previous / staffData.num_of_building}
                                      formatValue={formatValue}
                                    />
                                    </div>
                                  </div>
                              ...
                              <div className="row no-gutters align-items-center" style={{minWidth:200}}>
                                ...
                                <div className="row no-gutters align-items-center mt-2">
                                  <div className="col-auto">
                                    ...
                                    <AnimatedNumber
                                      className="font-weight-bold black ml-2"
                                      value={staffStatistic.registered_staff_prev}
                                      formatValue={formatValue}
                                    />
                                    </div>
                                  </div>
                        ...
                        <div className="col">
                          <div className="Container-dashboard-ns border-1 d-flex flex-column cursor-pointer">
                            <div className="row no-gutters align-items-center" style={{minWidth:200}}>
                              ...
                              <div className="col">
                                <div className="text-nowrap ml-3">Total Staff</div>
                                <AnimatedNumber
                                  className="h2 font-weight-bold black ml-3"
                                  value={staffStatistic.registered_staff}
                                  // value={staffData.num_of_login_staff}
              ...
              <div
                ...
                >
                  <div className="col-12">
                    ...
                    >
                      <div className="row">
                        <div className="col"><b>Settled Amount Billing</b></div>
                    ...
                    {auth.role === "sa" && (
                      ...
                      >
                        <div className="row">
                          <div className="col"><b>Disbursed Amount Billing</b></div>
                    ...
                    >
                      <div className="row">
                        <div className="col"><b>Unpaid Amount Billing</b></div>
                    ...
                    >
                      <div className="row">
                        <div className="col"><b>Unsettled Amount Billing</b></div>
                    ...
                    {auth.role === "sa" && (
                      ...
                      >
                        <div className="row">
                          <div className="col"><b>Undisbursed Amount Billing</b></div>
        ...
        <div className="Container-dashboard flex-column">
          ...
          <div className="row no-gutters">
            <div className="Container-user-statistic flex-column">
              <div className="row no-gutters">
                <div className="col-2 border-3" style={{borderTopLeftRadius:10}}>
                  Basic User
                </div>

                <div className="col-10 border-4" style={{borderTopRightRadius:10}}>
                  <div className="row no-gutters align-items-center">
                    {periode != "all" ?
                    <div className="col ml-3 mt-3" style={{minWidth:150}}>
                      <div className="text-nowrap">Total Basic User</div>
                      <AnimatedNumber
                        className="border-4-font font-weight-bold black"
                        value={residentStatistic.registered_resident_basic}
                        // value={staffData.num_of_login_staff}
                        formatValue={formatValue}
                      />
                    </div>
                    :
                    <div className="col ml-3 mb-3 mt-3" style={{minWidth:150}}>
                      <div className="text-nowrap">Total Basic User</div>
                      <AnimatedNumber
                        className="border-4-font font-weight-bold black"
                        value={residentStatistic.registered_resident_basic}
                    ...
                    <div className="row no-gutters align-items-center ml-3 mb-3">
                      <div className="col-auto">
                        ...
                        <AnimatedNumber
                          className="font-weight-bold black ml-2"
                          value={residentStatistic.registered_resident_basic_prev}
                          formatValue={formatValue}
                        />
                        </div>
                      </div>
                      <div className="col">
                        <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                          <font style={{color:"#52A452"}}>
                            {
                            (residentStatistic.registered_resident_basic_prev) != 0 ?
                            decimal((((residentStatistic.registered_resident_basic)-(residentStatistic.registered_resident_basic_prev))/(residentStatistic.registered_resident_basic_prev))*100)
                            :
                            0
                            }%
                          </font>
              ...
              <div className="row no-gutters">
                ...
                <div className="col-10 border-4">
                  <div className="row no-gutters align-items-center">
                    {periode != "all" ?
                    <div className="col ml-3 mt-3" style={{minWidth:150}}>
                      <div className="text-nowrap">Total Premium User</div>
                      <AnimatedNumber
                        className="border-4-font font-weight-bold black"
                        value={residentStatistic.registered_resident}
                        // value={staffData.num_of_login_staff}
                        ...
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              ...
                              decimal((((residentStatistic.owners)-(residentStatistic.owners_prev))/(residentStatistic.owners_prev))*100)
                              :
                              0
                              }%
                            </font>
                    ...
                    <div className="col ml-3 mt-3" style={{minWidth:150}}>
                      ...
                      <div className="row no-gutters align-items-center mb-3">
                        <div className="col-auto">
                          ...
                          <AnimatedNumber
                            className="font-weight-bold black ml-2"
                            value={residentStatistic.owners_family_prev}
                            formatValue={formatValue}
                          />
                          </div>
                        </div>
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              {
                              (residentStatistic.owners_family_prev) != 0 ?
                              decimal((((residentStatistic.owners_family)-(residentStatistic.owners_family_prev))/(residentStatistic.owners_family_prev))*100)
                              :
                              0
                              }%
                            </font>
                        ...
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              ...
                              decimal((((residentStatistic.tenants)-(residentStatistic.tenants_prev))/(residentStatistic.tenants_prev))*100)
                              :
                              0
                              }%
                            </font>
                    ...
                    <div className="col ml-3 mt-3" style={{minWidth:150}}>
                      ...
                      <div className="row no-gutters align-items-center mb-3">
                        <div className="col-auto">
                          ...
                          <AnimatedNumber
                            className="font-weight-bold black ml-2"
                            value={residentStatistic.tenants_family_prev}
                            formatValue={formatValue}
                          />
                          </div>
                        </div>
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              {
                              (residentStatistic.tenants_family_prev) != 0 ?
                              decimal((((residentStatistic.tenants_family)-(residentStatistic.tenants_family_prev))/(residentStatistic.tenants_family_prev))*100)
                              :
                              0
                              }%
                            </font>
              ...
              <div className="row no-gutters">
                <div className="col-2 border-3"style={{borderBottomLeftRadius:10}}>
                <div className="row no-gutters">
                  <div className="col-12">
                  <div className="col">
                    Active User
                ...
                <div className="col-10 border-4" style={{borderBottomRightRadius:10}}>
                  <div className="row no-gutters align-items-center">
                    {periode != "all" ?
                    <div className="col ml-3 mt-3" style={{minWidth:150}}>
                      ...
                      <AnimatedNumber
                        className="border-4-font font-weight-bold black"
                        // value={staffStatistic.num_of_login_staff}
                        value={residentStatistic.payment + residentStatistic.tasks + residentStatistic.announcement + residentStatistic.shop}
                        formatValue={formatValue}
                      />
                      {periode != "all" && (
                      <div className="row no-gutters align-items-center mb-3">
                        <div className="col-auto">
                          ...
                          <AnimatedNumber
                            className="font-weight-bold black ml-2"
                            value={residentStatistic.payment_prev + residentStatistic.tasks_prev + residentStatistic.announcement_prev + residentStatistic.shop_prev}
                            formatValue={formatValue}
                          />
                          </div>
                        </div>
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              {
                              (residentStatistic.payment_prev + residentStatistic.tasks_prev + residentStatistic.announcement_prev + residentStatistic.shop_prev) != 0 ?
                              decimal((((residentStatistic.payment + residentStatistic.tasks + residentStatistic.announcement + residentStatistic.shop)-(residentStatistic.payment_prev + residentStatistic.tasks_prev + residentStatistic.announcement_prev + residentStatistic.shop_prev))/(residentStatistic.payment_prev + residentStatistic.tasks_prev + residentStatistic.announcement_prev + residentStatistic.shop_prev))*100)
                              :
                              0
                              }%
                            </font>
                        ...
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              ...
                              decimal((((residentStatistic.payment)-(residentStatistic.payment_prev))/(residentStatistic.payment_prev))*100)
                              :
                              0
                              }%
                            </font>
                        ...
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              ...
                              decimal((((residentStatistic.tasks)-(residentStatistic.tasks_prev))/(residentStatistic.tasks_prev))*100)
                              :
                              0
                              }%
                            </font>
                    ...
                    <div className="col ml-3 mt-3" style={{minWidth:150}}>
                      ...
                      <div className="row no-gutters align-items-center mb-3">
                        <div className="col-auto">
                          ...
                          <AnimatedNumber
                            className="font-weight-bold black ml-2"
                            value={residentStatistic.announcement_prev}
                            formatValue={formatValue}
                          />
                          </div>
                        </div>
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              ...
                              decimal((((residentStatistic.announcement)-(residentStatistic.announcement_prev))/(residentStatistic.announcement_prev))*100)
                              :
                              0
                              }%
                            </font>
                        ...
                        <div className="col">
                          <div style={{ fontSize:12 }} className="text-nowrap ml-3">
                            <font style={{color:"#52A452"}}>
                              ...
                              decimal((((residentStatistic.shop)-(residentStatistic.shop_prev))/(residentStatistic.shop_prev))*100)
                              :
                              0
                              }%
                            </font>
