                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        Status
                            ...
                            <div className="row no-gutters" style={{ padding: '4px', alignItems: 'flex-start' }} >
                                <div className="col-auto" flex={3} style={{ fontWeight: 'bold', textAlign: 'left', minWidth: 200 }}>
                                    Availability
                                </div>
                                <div className="col" flex={9} style={{ fontWeight: 'normal' }}>
                                    {data.is_ready === 1 && data.is_ready_in === 0 ?
                                        <Pill color={ "success" }>Ready</Pill> : data.is_ready === 0 && data.is_ready_in === 1 ?
                                        <Pill color={ "warning" }>Preorder</Pill> : <Pill color={ "secondary" }>Open PO</Pill>
                                    }
                                </div>
                            </div>
                </div>
