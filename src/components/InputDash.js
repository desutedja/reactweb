            ...
            <input
              ...
              onChange={async (e) => {
                ...
                let ref = storageRef.child(
                  "building_logo/" + Date.now() + "-" + file.name
                );
        ...
        return (
          <div className="Input-container">
            <input
              ...
              onBlur={(e) => {
                !e.target.value || !e.target.value.match(/:/g)
                  ? setTimePick("00:00")
                  : setTimePick(e.target.value);
                setTimeout(() => {
                  setModalTime(false);
            ...
            <div className={"time-pick" + (modalTime ? " time-show" : "")}>
              <div className="time-wrap w-50 text-center">
                {rangeNumber(0, 23).map((n) => (
                  <p
                    className={
                      (n === hours ? "active" : "") + " text-center py-2"
                    }
                    onClick={(e) => {
              ...
              <div className="time-wrap w-50">
                {rangeNumber(0, 59).map((n) => (
                  <p
                    className={
                      (n === minutes ? "active" : "") + " text-center py-2"
                    }
                    onClick={(e) => {
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (type === "url") {
                  ...
                  setInputValue &&
                    setInputValue(
                      "http://" + e.target.value.replace("http://", "")
                    );
                }
                if (type === "tel") {
