    ...
    <div className="Table">
      ...
      >
        {filters.length > 0 && filters[activeFilter]
          ? filters[activeFilter].component(toggleModal)
          : null}
      </Modal>
      <Modal
        onClick={() => {
      ...
      >
        <Input
          ...
          options={[
            ...
            ...sortBy.map((el) => ({ label: toSentenceCase(el), value: el })),
          ]}
        ...
        <Input
          ...
          inputValue={sortType}
          setInputValue={setSortTypeInput}
        />
      </Modal>
      {tableAction && (
        <>
          ...
          {filters.length > 0 && (
            <div className={"FilterContainerNew" + (filter ? " down" : "")}>
              {filters.map(
                (el, index) =>
                  !el.hidden && (
                    <FilterButton
          ...
          <div className="TableActionBil">
            ...
            <div
              className="TableAction-right d-flex align-items-center"
              style={{ marginLeft: "4px" }}
            >
              <div
                className="TableDatePicker d-flex align-items-center"
                ...
                return (
                  <>
                    ...
                    {row.isExpanded ? (
                      <tr>
                        <td
                          className="SubRowComponent"
                          colSpan={visibleColumns.length}
                        >
                          {row.original.subComponent &&
                            row.original.subComponent(row.original)}
                        </td>
                      </tr>
                    ) : null}
                  </>
            ...
            {parseInt(pageIndex) === pageCount - 1 ? (
              <>
                ...
                <IconButton
                  ...
                  className="PageControl"
                  onClick={() =>
                    setPageIndex(pageCount - 1) && gotoPage(pageCount - 1)
                  }
                >
                  <FiChevronsRight />
                </IconButton>
